...
public class ButtonResistor : MonoBehaviour, IPointerClickHandler
{
   ...
   {
      scPlayer.scPuzzles.buttonName = "Resistor";
      ...
      scPlayer.scInventario.titulo.text = "Resistor";
      scPlayer.scInventario.descricao.text = "Serve para limitar, diminuir ou dividir a tensão em alguma parte do circuito.";

      scPlayer.scInventario.imgResistor.enabled = true;
